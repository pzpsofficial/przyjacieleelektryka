...
_gsap.gsap.registerPlugin(_ScrollTrigger.ScrollTrigger); // Animacje dla sekcji hero


var herotl = _gsap.gsap.timeline();

herotl.add(_gsap.gsap.to('.overlay__content', {
  duration: 1,
  opacity: 1
})).add(_gsap.gsap.to('.overlay', {
  xPercent: -100,
  delay: 0.5,
  duration: 1,
  ease: 'circ'
})).add(_gsap.gsap.fromTo('.text', {
  yPercent: -150,
  opacity: 0
}, {
  duration: 0.8,
...
document.querySelectorAll('.section').forEach(function (section) {
  ...
  _gsap.gsap.fromTo(section.querySelector('.img'), {
    xPercent: xImg
  }, {
    duration: 1,
    xPercent: 0,
  ...
  _gsap.gsap.fromTo(section.querySelector('.content'), {
    xPercent: xText
  }, {
    duration: 1,
    xPercent: 0,
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/animations.js"], null)
//# sourceMappingURL=/animations.e6ae2fc7.js.map